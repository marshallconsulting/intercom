...
- A project with external data sources (logs, client config, Google Calendar) and no documentation home in the repo
- A project with strategic memos and vendor documents that don't fit specs or research
- A project with regulatory documents, competitive analysis dumps, and investor materials from external sources
