...
```
/create-proposal https://github.com/owner/repo/issues/123
```
...
- **Schemas / data model**: `path/to/model` - what it does, key fields
- **Core logic / services**: `path/to/service` - what it does, what calls it
- **Routes / handlers**: `path/to/handler` - which actions use what
- **UI / views**: `path/to/view` - what displays this data
- **Config**: `path/to/config` - relevant configuration
- **Tests**: `path/to/tests` - what's covered
