...
- **Multiple proposals:** Use `AskUserQuestion` to let the user pick, or list the 5 most recent (sorted by file modification time, newest first) as a numbered list:
...
3. presence-heartbeat.md (Mar 31)
4. inbox-gc.md (Mar 28)
5. registry-ttl.md (Mar 28)
```
